pipeline {
    ...
    stages {
        ...
        stage('Cretae Docker Container') {
            steps {
                script {
                    bat "docker run -d --name quizautomationcontainer -p 8000:8000  vaibhavkalel/quizautomation"
                }
            }
        }
            ...
            steps {
                ...
                script {
                    ...
                    withCredentials([usernamePassword(credentialsId: 'docker-cred', usernameVariable: 'DOCKERHUB_USERNAME', passwordVariable: 'DOCKERHUB_PASSWORD')]) {
                        ...
                        bat 'docker push vaibhavkalel/quizautomation'
